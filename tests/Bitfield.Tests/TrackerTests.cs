...
internal static class TrackerTests
{
    ...
    private static void PeerIds(Action<string, bool, string> check)
    {
        ...
        check("peer id: names this client", text.StartsWith("-BF1010-", StringComparison.Ordinal), text);
        ...
        check("peer id: reads back its own client name",
            generated.ClientName() == "Bitfield 1.0.1", generated.ClientName());
